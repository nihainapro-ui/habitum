...
/** `nu` : sans son panneau — sous 768 px, la liste vit dans une section
 *  repliée de la vue, et une carte dans une carte est proscrite (PDF p. 17). */
export function ShoppingList({ nu = false }: { nu?: boolean } = {}) {

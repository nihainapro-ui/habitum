...
| `demo` | le jeu de démonstration a été chargé — l'en-tête de bureau l'affiche en permanence (B4) ; sur téléphone, la carte de profil de « Plus » et la vue Profil | `seedDemo()` |
